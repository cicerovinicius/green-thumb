...
var app = {
  ...
  plugins: {
    slick: {
      slidePlants: function slidePlants(enabled) {
        if (enabled) {
  ...
  functions: {
    ...
    showPlants: function showPlants(data) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        plant += '<div class="img"><img src="' + data[i].url + '" alt="plant" title="green thumb" /></div>' + '<h2 class="name" title="' + data[i].name + ' | green thumb">' + data[i].name + '</h2>' + '<div class="price-types">' + '<span class="price">$' + data[i].price + '</span>' + '<ul class="types">' + '<li class="type dog" data-status="' + data[i].toxicity + '" title="' + (data[i].toxicity ? 'toxic' : 'non-toxic') + '"></li>' + '<li class="type sunlight" data-status="' + data[i].sun + '" title="' + data[i].sun + ' sunlight"></li>' + '<li class="type water" data-status="' + data[i].water + '" title="water ' + data[i].water + '"></li>' + '</ul></div>' + '</div></li>';
...
__webpack_require__(/*! C:\Users\KBRTEC\Desktop\green-thumb-master\assets\src\js\app.js */"./assets/src/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\KBRTEC\Desktop\green-thumb-master\assets\src\scss\app.scss */"./assets/src/scss/app.scss");
