...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/dist/js/scripts.min.js":[function(require,module,exports) {
...
!function (e) {
  ...
  !function (t, n) {
    ...
    k.filter = function (e, t, n) {
      ...
      is: function is(e) {
        return !!L(this, "string" == typeof e && E.test(e) ? k(e) : e || [], !1).length;
      }
    });
    var H,
        N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (k.fn.init = function (e, t, n) {
      ...
      if (n = n || H, "string" == typeof e) {
        ...
        if (i[1]) {
          if (t = t instanceof k ? t[0] : t, k.merge(this, k.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : w, !0)), D.test(i[1]) && k.isPlainObject(t)) for (i in t) {
    ...
    k.fn.extend({
      ...
      k.fn[e] = function (n, i) {
        ...
        return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = k.filter(i, o)), this.length > 1 && (P[e] || k.uniqueSort(o), O.test(e) && o.reverse()), this.pushStack(o);
      };
    });
    var M = /[^\x20\t\r\n\f]+/g;
              ...
              return function () {
                var a = this,
                  ...
                  if (!(e < r)) {
                    ...
                    c = n && ("object" == _typeof(n) || "function" == typeof n) && n.then, y(c) ? o ? c.call(n, s(r, t, I, o), s(r, t, z, o)) : (r++, c.call(n, s(r, t, I, o), s(r, t, z, o), s(r, t, I, t.notifyWith))) : (i !== I && (a = void 0, l = [n]), (o || t.resolveWith)(a, l));
                  }
                },
                    d = o ? c : function () {
                  try {
    ...
    function Te(e, t, n, i, o) {
      for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) {
        if ((r = e[f]) || 0 === r) if ("object" === T(r)) k.merge(p, r.nodeType ? [r] : r);else if (xe.test(r)) {
      ...
      for (u.textContent = "", f = 0; r = p[f++];) {
        if (i && k.inArray(r, i) > -1) o && o.push(r);else if (c = se(r), s = we(u.appendChild(r), "script"), c && be(s), n) for (d = 0; r = s[d++];) {
      ...
      n ? (J.set(e, t, !1), k.event.add(e, t, {
        ...
        handler: function handler(e) {
          ...
          if (1 & e.isTrigger && this[t]) {
            if (r.length) (k.event.special[t] || {}).delegateType && e.stopPropagation();else if (r = a.call(arguments), J.set(this, t, r), i = n(this, t), this[t](), r !== (o = J.get(this, t)) || i ? J.set(this, t, !1) : o = {}, r !== o) return e.stopImmediatePropagation(), e.preventDefault(), o && o.value;
    ...
    k.event = {
      ...
      add: function add(e, t, n, i, o) {
        var r,
            ...
            v,
            g = J.get(e);
        if (G(e)) for (n.handler && (n = (r = n).handler, o = r.selector), o && k.find.matchesSelector(re, o), n.guid || (n.guid = k.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
          return void 0 !== k && k.event.triggered !== t.type ? k.event.dispatch.apply(e, arguments) : void 0;
        }), c = (t = (t || "").match(M) || [""]).length; c--;) {
          f = v = (a = ke.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = k.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = k.event.special[f] || {}, d = k.extend({
            type: f,
            origType: v,
            data: i,
            handler: n,
      ...
      remove: function remove(e, t, n, i, o) {
        ...
        if (g && (l = g.events)) {
          for (c = (t = (t || "").match(M) || [""]).length; c--;) {
            if (f = v = (a = ke.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
      ...
      special: {
        ...
        click: {
          setup: function setup(e) {
            var t = this || e;
            return ve.test(t.type) && t.click && j(t, "input") && Ee(t, "click", Se), !1;
          },
          trigger: function trigger(e) {
            var t = this || e;
            return ve.test(t.type) && t.click && j(t, "input") && Ee(t, "click"), !0;
          },
    ...
    function Pe(e, t) {
      ...
      if (1 === t.nodeType) {
        if (J.hasData(e) && (a = J.get(e).events)) for (o in J.remove(t, "handle events"), a) {
    ...
    function Me(e, t, n, i) {
      ...
      if (p && (r = (o = Te(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
        for (a = (s = k.map(we(o, "script"), Ne)).length; u < p; u++) {
          c = o, u !== f && (c = k.clone(c, !0, !0), a && k.merge(s, we(c, "script"))), n.call(e[u], c, u);
        }

        if (a) for (d = s[s.length - 1].ownerDocument, k.map(s, Oe), u = 0; u < a; u++) {
    ...
    k.extend({
      ...
      clone: function clone(e, t, n) {
        var i,
            ...
            a = e.cloneNode(!0),
            l = se(e);
        if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || k.isXMLDoc(e))) for (s = we(a), i = 0, o = (r = we(e)).length; i < o; i++) {
          qe(r[i], s[i]);
        }
      ...
      html: function html(e) {
        return _(this, function (e) {
          ...
          if ("string" == typeof e && !je.test(e) && !me[(ge.exec(e) || ["", ""])[1].toLowerCase()]) {
            e = k.htmlPrefilter(e);
    ...
    function Be(e, t, n) {
      var i,
          ...
          s,
          a = e.style;
      return (n = n || We(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || se(e) || (s = k.style(e, t)), !g.pixelBoxStyles() && ze.test(s) && Fe.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s;
    }
    ...
    function tt(e, t, n) {
      ...
      return (!g.boxSizingReliable() && o || !g.reliableTrDimensions() && j(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === k.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === k.css(e, "boxSizing", !1, i), (r = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + et(e, t, n || (o ? "border" : "content"), r, i, s) + "px";
    }
    ...
    k.extend({
      ...
      style: function style(e, t, n, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
              ...
              l = Qe.test(t),
              c = e.style;
          if (l || (t = Ve(a)), s = k.cssHooks[t] || k.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
          "string" === (r = _typeof(n)) && (o = ie.exec(n)) && o[1] && (n = ce(e, t, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (k.cssNumber[a] ? "" : "px")), g.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n));
        }
      },
      css: function css(e, t, n, i) {
        var o,
            ...
            s,
            a = V(t);
        return Qe.test(t) || (t = Ve(a)), (s = k.cssHooks[t] || k.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Be(e, t, i)), "normal" === o && t in Ke && (o = Ke[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o;
      }
    }), k.each(["height", "width"], function (e, t) {
      k.cssHooks[t] = {
        get: function get(e, n, i) {
          if (n) return !Ge.test(k.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, i) : Re(e, Je, function () {
            return tt(e, t, i);
          });
        },
        set: function set(e, n, i) {
          var o,
              ...
              l = i ? et(e, t, i, a, r) : 0;
          return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - et(e, t, "border", !1, r) - .5)), l && (o = ie.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = k.css(e, t)), Ze(0, n, l);
        }
      };
    }), k.cssHooks.marginLeft = _e(g.reliableMarginLeft, function (e, t) {
    ...
    function ut(e, t, n) {
      ...
      for (!function (e, t) {
        ...
        for (n in e) {
          if (o = t[i = V(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = k.cssHooks[i]) && ("expand" in s)) for (n in r = s.expand(r), delete e[i], r) {
            (n in e) || (e[n] = r[n], t[n] = o);
          } else t[i] = o;
        }
      }(d, c.opts.specialEasing); r < s; r++) {
        if (i = ut.prefilters[r].call(c, e, d, c.opts)) return y(i.stop) && (k._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
      }

      return k.map(d, dt, c), y(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), k.fx.timer(k.extend(l, {
        elem: e,
        anim: c,
        queue: c.opts.queue
      })), c;
    ...
    k.Animation = k.extend(ut, {
      ...
      prefilters: [function (e, t, n) {
        ...
        if ((l = !k.isEmptyObject(t)) || !k.isEmptyObject(f)) for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = J.get(e, "display")), "none" === (d = k.css(e, "display")) && (c ? d = c : (pe([e], !0), c = e.style.display || c, d = k.css(e, "display"), pe([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === k.css(e, "float") && (l || (p.done(function () {
          h.display = c;
    ...
    k.fn.extend({
      ...
      attr: function attr(e, t, n) {
        var i,
            o,
            r = e.nodeType;
        if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? k.prop(e, t, n) : (1 === r && k.isXMLDoc(e) || (o = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void k.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = k.find.attr(e, t)) ? void 0 : i);
      },
      attrHooks: {
        type: {
    ...
    k.fn.extend({
      ...
      toggleClass: function toggleClass(e, t) {
        ...
        return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : y(e) ? this.each(function (n) {
          ...
          var t, o, r, s;
          if (i) for (o = 0, r = k(this), s = mt(e); t = s[o++];) {
      ...
      trigger: function trigger(e, t, i, o) {
        ...
        if (s = p = a = i = i || w, 3 !== i.nodeType && 8 !== i.nodeType && !bt.test(v + k.event.triggered) && (v.indexOf(".") > -1 && (g = v.split("."), v = g.shift(), g.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[k.expando] ? e : new k.Event(v, "object" == _typeof(e) && e)).isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : k.makeArray(t, [e]), u = k.event.special[v] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, t))) {
          ...
          for (r = 0; (s = h[r++]) && !e.isPropagationStopped();) {
            p = s, e.type = r > 1 ? l : u.bindType || v, (d = (J.get(s, "events") || Object.create(null))[e.type] && J.get(s, "handle")) && d.apply(s, t), (d = c && s[c]) && d.apply && G(s) && (e.result = d.apply(s, t), !1 === e.result && e.preventDefault());
          }

          return e.type = v, o || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(h.pop(), t) || !G(i) || c && y(i[v]) && !m(i) && ((a = i[c]) && (i[c] = null), k.event.triggered = v, e.isPropagationStopped() && p.addEventListener(v, xt), i[v](), e.isPropagationStopped() && p.removeEventListener(v, xt), k.event.triggered = void 0, a && (i[c] = a)), e.result;
        }
      },
    ...
    k.param = function (e, t) {
      ...
      serializeArray: function serializeArray() {
        return this.map(function () {
          ...
          var e = this.type;
          return this.name && !k(this).is(":disabled") && Et.test(this.nodeName) && !At.test(e) && (this.checked || !ve.test(e));
        }).map(function (e, t) {
          var n = k(this).val();
    ...
    zt.href = Tt.href, k.extend({
      ...
      ajax: function ajax(e, t) {
        ...
        if (g.promise(S), f.url = ((e || f.url || Tt.href) + "").replace(Pt, Tt.protocol + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(M) || [""], null == f.crossDomain) {
          l = w.createElement("a");
    ...
    g.cors = !!_t && "withCredentials" in _t, g.ajax = _t = !!_t, k.ajaxTransport(function (e) {
      var _t3, i;
      ...
      if (g.cors || _t && !e.crossDomain) return {
        send: function send(o, r) {
          ...
          _t3 = function t(e) {
            return function () {
              _t3 && (_t3 = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Bt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                binary: a.response
              } : {
                text: a.responseText
    ...
    k.ajaxSetup({
      ...
      if (a || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Yt, "$1" + o) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
        ...
        void 0 === r ? k(n).removeProp(o) : n[o] = r, e[o] && (e.jsonpCallback = t.jsonpCallback, Xt.push(o)), s && y(r) && r(s[0]), s = r = void 0;
      }), "script";
    }), g.createHTMLDocument = ((Ut = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ut.childNodes.length), k.parseHTML = function (e, t, n) {
      return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (g.createHTMLDocument ? ((i = (t = w.implementation.createHTMLDocument("")).createElement("base")).href = w.location.href, t.head.appendChild(i)) : t = w), r = !n && [], (o = D.exec(e)) ? [t.createElement(o[1])] : (o = Te([e], t, r), r && r.length && k(r).remove(), k.merge([], o.childNodes)));
      var i, o, r;
      ...
      var i,
          ...
          s = this,
          a = e.indexOf(" ");
      return a > -1 && (i = gt(e.slice(a)), e = e.slice(0, a)), y(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (o = "POST"), s.length > 0 && k.ajax({
        url: e,
        type: o || "GET",
        dataType: "html",
        data: t
      ...
      k.cssHooks[t] = _e(g.pixelPosition, function (e, n) {
        if (n) return n = Be(e, t), ze.test(n) ? k(e).position()[t] + "px" : n;
      });
    }), k.each({
      Height: "height",
      Width: "width"
    ...
    return k.noConflict = function (e) {
      return n.$ === k && (n.$ = Qt), e && n.jQuery === k && (n.jQuery = Gt), k;
    }, void 0 === o && (n.jQuery = n.$ = k), k;
  });
}, function (e, t, n) {
  n(2), e.exports = n(4);
}, function (e, t, n) {
  window.$ = window.jQuery = n(0), n(3);
  var i = {
    breakpoints: {
    ...
    plugins: {
      slick: {
        slidePlants: function slidePlants(e) {
          e && ($("#results-area").hasClass("slick-initialized") ? $("#results-area").slick("reinit") : $("#results-area").slick({
            centerMode: !0,
            autoplay: !1,
            dots: !1,
            infinite: !1,
    ...
    functions: {
      selectList: function selectList() {
        $(".select-box.open").on("click", function (e) {
          e.stopPropagation(), $(this).removeClass("open");
        }), $(".select-label-list .select-label").on("click", function () {
          $(this).parent(".select-box").removeClass("open");
        }), $(document).on("click", function (e) {
          var t = e.target;
          !$(t).is(".select-box") && !$(t).parents().is(".select-box") || $(t).is(".select-box.open") ? $(".select-box").removeClass("open") : ($(t).is(".select-text") || $(t).is(".select-option")) && ($(t).parents(".select-box").hasClass("open") || $(t).parents(".select-box").addClass("open"));
        }), i.functions.onSelectChange();
      },
      onSelectChange: function onSelectChange() {
        $("input.select-radio").on("change", function () {
          var e = $('input[name="sun"]:checked').val(),
              t = $('input[name="pets"]:checked').val(),
              n = $('input[name="water"]:checked').val();
          if ("unselected" == e && "unselected" == t && "unselected" == n) $("#results").addClass("hidden"), $("#no-results").removeClass("hidden"), document.getElementById("results-area").innerHTML = "";else {
            var o = {
              sun: "unselected" == e ? "no" : e,
              pets: "unselected" == t ? "false" : t,
              water: "unselected" == n ? "regularly" : n
            };
            i.functions.loadPlants(o), $("#no-results").addClass("hidden"), $("#results").removeClass("hidden");
          }
        });
      },
      loadPlants: function loadPlants(e) {
        var t = e.sun || "no",
            n = e.pets || "false",
            o = e.water || "regularly",
            r = new XMLHttpRequest();
        r.open("get", "https://front-br-challenges.web.app/api/v2/green-thumb/?sun=" + t + "&water=" + o + "&pets=" + n), r.onload = function () {
          var e = JSON.parse(r.responseText);
          e.status && 404 === e.status ? ($("#no-results").removeClass("hidden"), $("#results").addClass("hidden"), document.getElementById("results-area").innerHTML = "") : document.getElementById("results-area").innerHTML = i.functions.showPlants(e), i.functions.activeSlider();
        }, r.send(null);
      },
      showPlants: function showPlants(e) {
        for (var t = "", n = "", i = 0; i < e.length; i++) {
          var o = '<li class="result"><div class="wrap">';
          e[i].staff_favorite && (o += '<span class="favorite">&#10024; Staff favorite</span>'), o += '<div class="img"><img src="' + e[i].url + '" alt="plant" title="green thumb" /></div><h2 class="name" title="' + e[i].name + ' | green thumb">' + e[i].name + '</h2><div class="price-types"><span class="price">$' + e[i].price + '</span><ul class="types"><li class="type dog" data-status="' + e[i].toxicity + '" title="' + (e[i].toxicity ? "toxic" : "non-toxic") + '"></li><li class="type sunlight" data-status="' + e[i].sun + '" title="' + e[i].sun + ' sunlight"></li><li class="type water" data-status="' + e[i].water + '" title="water ' + e[i].water + '"></li></ul></div></div></li>', e[i].staff_favorite ? n += o : t += o;
        }

        return t = n + t;
      },
      activeSlider: function activeSlider() {
        i.functions.checkDevice("mobile") ? i.plugins.slick.slidePlants(!0) : i.plugins.slick.slidePlants(!1), $(window).on("resize", function () {
          i.functions.checkDevice("mobile") ? i.plugins.slick.slidePlants(!0) : i.plugins.slick.slidePlants(!1);
        });
      },
      ...
      checkDevice: function checkDevice(e) {
        return e = i.breakpoints[e], !!window.matchMedia(e).matches;
      }
    },
    init: function init() {
      $(document).ready(function () {
        i.functions.smoothAncora(), i.functions.selectList();
      });
    }
  };
  window.app = i, i.init();
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/dist/js/scripts.min.js"], null)
//# sourceMappingURL=/scripts.min.6e2356ee.js.map